...
public class RecyclerViewAdapterCCTV extends RecyclerView.Adapter<RecyclerViewAdapterCCTV.MyViewHolder2> {
    Context context;
    List<Book> bookList;


    public RecyclerViewAdapterCCTV(Context context, List<Book> bookList) {
    ...
    public MyViewHolder2 onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = layoutInflater.inflate(R.layout.cardview_item_book_cctv, viewGroup, false);
