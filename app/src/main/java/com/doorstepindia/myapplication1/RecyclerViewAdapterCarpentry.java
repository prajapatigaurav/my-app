...
public class RecyclerViewAdapterCarpentry extends RecyclerView.Adapter<RecyclerViewAdapterCarpentry.MyViewHolder2> {
    Context context;
    List<Book> bookList;


    public RecyclerViewAdapterCarpentry(Context context, List<Book> bookList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder2 myViewHolder2, final int i) {
        ...
        myViewHolder2.cardView2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (i) {
                    case 0:
                        Intent intent = new Intent(context, GeneralCarpentryActivity.class);
                        context.startActivity(intent);
                        break;
                    case 1:
                        Intent intent1 = new Intent(context, NewFurnitureActivity.class);
                        context.startActivity(intent1);
                        break;
                    case 2:
                        Intent intent2 = new Intent(context, FurnitureRepairActivity.class);
                        context.startActivity(intent2);
                        break;
                    case 3:
                        Intent intent3 = new Intent(context, FurnitureAssemblyActivity.class);
                        context.startActivity(intent3);
                        break;
                    case 4:
                        Intent intent4 = new Intent(context, DoorOrWindowActivity.class);
