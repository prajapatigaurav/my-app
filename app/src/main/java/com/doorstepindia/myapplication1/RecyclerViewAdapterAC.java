...
public class RecyclerViewAdapterAC extends RecyclerView.Adapter<RecyclerViewAdapterAC.MyViewHolder2> {
    Context context;
    List<Book> bookList;


    public RecyclerViewAdapterAC(Context context, List<Book> bookList) {
